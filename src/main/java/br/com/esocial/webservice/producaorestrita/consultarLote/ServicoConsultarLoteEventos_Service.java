 ...
 * 
 */
@WebServiceClient(name = "ServicoConsultarLoteEventos", targetNamespace = "http://www.esocial.gov.br/servicos/empregador/lote/eventos/envio/consulta/retornoProcessamento/v1_1_0", wsdlLocation = "file:/D:/Esocial/ws/envioLote/WsConsultarLoteEventos.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
        	url = new URL("file:"+System.getProperty("user.dir")+"/WsConsultarLoteEventos.wsdl");
        	//CodeSource codeSource = ServicoConsultarLoteEventos_Service.class.getProtectionDomain().getCodeSource();
        	//File          jarFile = new File(codeSource.getLocation().toURI().getPath());
        	//String         jarDir = jarFile.getParentFile().getPath();
        	//url = new URL("file:/"+jarDir+"/../WsConsultarLoteEventos.wsdl");
            //url = new URL("file:/C:/development/poc/e-social/envioLote/WsConsultarLoteEventos.wsdl");
